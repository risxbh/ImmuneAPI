...
const { loginDelivery, registerDelivery, upload, updateDelivery, deleteDelivery, getAll,assignOrderToPartner,getAvailableOrders, getUserbyId } = require('../controllers/deliveryPartnerController');
